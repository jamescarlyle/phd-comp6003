...
GENERATIONS = 600
MAX_STEPS   = 1600
NUM_RUNS    = 1  # BipedalWalker is slow, fewer runs needed
...
NODE_NAMES = {
    ...
    -5:  "hip joint 1 angle",
    -6:  "hip joint 1 speed",
    -7:  "knee joint 1 angle",
    -8:  "knee joint 1 speed",
    -9:  "leg 1 contact",
    -10: "hip joint 2 angle",
    -11: "hip joint 2 speed",
    -12: "knee joint 2 angle",
    -13: "knee joint 2 speed",
    -14: "leg 2 contact",
    -15: "lidar 1",
    -16: "lidar 2",
    -17: "lidar 3",
...
def eval_genomes(genomes, config):
    ...
    for genome_id, genome in genomes:
        ...
        if genome.fitness > best_fitness:
            ...
            # Overwrite the HTML report for the new best
            save_network_report(
                best_genome, config,
                filename="network_report_best.html",
...
# ── Network report (final) ─────────────────────────────────────────────────────
save_network_report(winner, config,
                    filename="network_report_final.html",
                    node_names=NODE_NAMES)
